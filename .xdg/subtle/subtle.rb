...
gravity :center100,      [ 100, 100, 100, 100 ]
...
#grab "W-KP_5", [ :center,    :center66,   :center33  :center100  ]
...
grab "W-s", [ :center100,       :center66,       :center33       ]
...
begin
  require "#{ENV["HOME"]}/.subtle/launcher.rb" 
 # Set fonts
 Subtle::Contrib::Launcher.fonts = [
   "xft:Inconsolata:pixelsize=80:antialias=true",
...
on :start do
 Subtlext::Subtle.spawn "setxkbmap pt"
 Subtlext::Subtle.spawn "blueman-applet"
 Subtlext::Subtle.spawn "sh ~/.autostart.sh"
end
